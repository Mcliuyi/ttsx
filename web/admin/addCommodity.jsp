                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-line-form" method="post" action="add">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="user_name" name="user_name" placeholder="请输入商品名">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" id="commodity_info" name="commodity_info" placeholder="请输入商品介绍">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="price" name="price" placeholder="输入商品价格">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="unit" name = "unit" placeholder="输入商品单位">
                                        <small>请填写以g为单位。</small>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="image" class="am-u-sm-3 am-form-label">商品图 <span class="tpl-form-line-small-title">Images</span></label>
                                    <div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="10" id="introduction" name="introduction" placeholder="请输入商品详细介绍"></textarea>
                                    </div>
                                </div>
